...
<br>"--new": to add a new todo item
<br>"--list [all|pending|done]": to list the todo items
<br>"--done [id]": to update a todo item
<br>"--delete [id]": to delete a todo item
<br>"--help": to list all the available options
<br>"--version": to print the version of the application
